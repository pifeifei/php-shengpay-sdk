...
class CredentialsProvider
{
    ...
    public static function env()
    {
        return static function () {
            $accessKeyId     = \Pff\Client\envNotEmpty('ALIBABA_CLOUD_ACCESS_KEY_ID');
            $accessKeySecret = \Pff\Client\envNotEmpty('ALIBABA_CLOUD_ACCESS_KEY_SECRET');
    ...
    {
        return static function () {
            $ini = \Pff\Client\envNotEmpty('ALIBABA_CLOUD_CREDENTIALS_FILE');
    ...
    {
        $name = \Pff\Client\envNotEmpty('ALIBABA_CLOUD_PROFILE');
    ...
    {
        return static function () {
            $instance = \Pff\Client\envNotEmpty('ALIBABA_CLOUD_ECS_METADATA');
            if ($instance) {
